...
// --- Extension metadata -----------------------------------------------
val extName = "MangaMikan"
val extClass = ".Mangamikan"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.mangamikan"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.mangamikan"
        minSdk = 21
        targetSdk = 34
