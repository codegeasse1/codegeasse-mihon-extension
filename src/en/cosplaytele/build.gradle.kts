...
// --- Extension metadata -----------------------------------------------
val extName = "CosplayTele"
val extClass = ".Cosplaytele"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.cosplaytele"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.cosplaytele"
        minSdk = 21
        targetSdk = 34
