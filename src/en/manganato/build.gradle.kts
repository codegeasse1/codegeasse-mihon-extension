...
// --- Extension metadata -----------------------------------------------
val extName = "Manganato"
val extClass = ".Manganato"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.manganato"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.manganato"
        minSdk = 21
        targetSdk = 34
