...
// --- Extension metadata -----------------------------------------------
val extName = "NovelCrow"
val extClass = ".Novelcrow"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.novelcrow"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.novelcrow"
        minSdk = 21
        targetSdk = 34
