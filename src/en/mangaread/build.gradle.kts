...
// --- Extension metadata -----------------------------------------------
val extName = "MangaRead"
val extClass = ".MangaRead"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.mangaread"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.mangaread"
        minSdk = 21
        targetSdk = 34
