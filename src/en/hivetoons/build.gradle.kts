...
// --- Extension metadata -----------------------------------------------
val extName = "HiveToons"
val extClass = ".HiveToons"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.hivetoons"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.hivetoons"
        minSdk = 21
        targetSdk = 34
