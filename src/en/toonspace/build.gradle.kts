...
// --- Extension metadata -----------------------------------------------
val extName = "ToonSpace"
val extClass = ".ToonSpace"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.toonspace"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.toonspace"
        minSdk = 21
        targetSdk = 34
