...
// --- Extension metadata -----------------------------------------------
val extName = "MangaTown"
val extClass = ".MangaTown"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.mangatown"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.mangatown"
        minSdk = 21
        targetSdk = 34
