...
// --- Extension metadata -----------------------------------------------
val extName = "HentaiFox"
val extClass = ".HentaiFox"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.hentaifox"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.hentaifox"
        minSdk = 21
        targetSdk = 34
