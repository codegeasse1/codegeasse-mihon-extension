...
// --- Extension metadata -----------------------------------------------
val extName = "MangaFreak"
val extClass = ".MangaFreak"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.mangafreak"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.mangafreak"
        minSdk = 21
        targetSdk = 34
