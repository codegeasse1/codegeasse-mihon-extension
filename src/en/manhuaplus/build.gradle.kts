...
// --- Extension metadata -----------------------------------------------
val extName = "ManhuaPlus"
val extClass = ".ManhuaPlus"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.manhuaplus"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.manhuaplus"
        minSdk = 21
        targetSdk = 34
