...
// --- Extension metadata -----------------------------------------------
val extName = "MangaTaro"
val extClass = ".MangaTaro"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.mangataro"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.mangataro"
        minSdk = 21
        targetSdk = 34
