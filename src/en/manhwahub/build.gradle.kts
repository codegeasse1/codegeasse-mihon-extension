...
// --- Extension metadata -----------------------------------------------
val extName = "ManhwaHub"
val extClass = ".ManhwaHub"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.manhwahub"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.manhwahub"
        minSdk = 21
        targetSdk = 34
