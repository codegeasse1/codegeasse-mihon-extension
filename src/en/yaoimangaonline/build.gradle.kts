...
// --- Extension metadata -----------------------------------------------
val extName = "Yaoi Manga Online"
val extClass = ".YaoiMangaOnline"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.yaoimangaonline"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.yaoimangaonline"
        minSdk = 21
        targetSdk = 34
