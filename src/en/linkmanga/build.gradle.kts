...
// --- Extension metadata -----------------------------------------------
val extName = "Linkmanga"
val extClass = ".Linkmanga"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.linkmanga"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.linkmanga"
        minSdk = 21
        targetSdk = 34
