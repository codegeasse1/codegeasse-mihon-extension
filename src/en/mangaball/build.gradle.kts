...
// --- Extension metadata -----------------------------------------------
val extName = "MangaBall"
val extClass = ".MangaBall"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.mangaball"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.mangaball"
        minSdk = 21
        targetSdk = 34
