...
// --- Extension metadata -----------------------------------------------
val extName = "AquaManga"
val extClass = ".AquaManga"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.aquamanga"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.aquamanga"
        minSdk = 21
        targetSdk = 34
