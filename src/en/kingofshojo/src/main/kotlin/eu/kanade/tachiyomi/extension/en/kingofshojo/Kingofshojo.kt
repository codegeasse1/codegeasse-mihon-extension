...
/*
 * Kingofshojo (https://kingofshojo.com) — MangaThemesia theme (WordPress).
 * Shoujo/romance aggregator (Ozul Scans).
 *
 ...
 *               table.infotable rows (Status/Author/Artist), .seriestugenre a genres,
 *               .entry-content-single description
 *     Chapters: .eplister li .eph-num a           -> chapter URL /<slug>-chapter-<n>/
 *     Chapter : /<slug>-chapter-<n>/              -> #readerarea images, else page embeds
 *               a reader config JSON with "images": [url, ...]
 */
class Kingofshojo : HttpSource() {

    override val name = "Kingofshojo"
    override val baseUrl = "https://kingofshojo.com"
