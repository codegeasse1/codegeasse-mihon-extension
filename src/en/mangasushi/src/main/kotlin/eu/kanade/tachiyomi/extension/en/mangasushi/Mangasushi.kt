...
class Mangasushi : HttpSource() {
    ...
    private fun parseList(response: Response): MangasPage {
        ...
        // The flat anchor selector grabbed nav/tab links ("Manga", "ARCHIVES", "All Mangas"),
        // the cover <a> (empty text -> img alt like "LONELY"), AND the real title <a>;
        // distinctBy then kept the junk entries. Scope to cards instead:
