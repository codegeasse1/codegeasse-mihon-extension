...
// --- Extension metadata -----------------------------------------------
val extName = "Manhwa18CC"
val extClass = ".Manhwa18Cc"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.manhwa18cc"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.manhwa18cc"
        minSdk = 21
        targetSdk = 34
