...
// --- Extension metadata -----------------------------------------------
val extName = "HentaiZap"
val extClass = ".HentaiZap"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.hentaizap"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.hentaizap"
        minSdk = 21
        targetSdk = 34
