...
// --- Extension metadata -----------------------------------------------
val extName = "AsmHentai"
val extClass = ".AsmHentai"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.asmhentai"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.asmhentai"
        minSdk = 21
        targetSdk = 34
