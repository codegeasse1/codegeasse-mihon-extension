...
// --- Extension metadata -----------------------------------------------
val extName = "GalaxyManga"
val extClass = ".GalaxyManga"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.galaxymanga"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.galaxymanga"
        minSdk = 21
        targetSdk = 34
