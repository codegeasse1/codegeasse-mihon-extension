...
// --- Extension metadata -----------------------------------------------
val extName = "Manga District"
val extClass = ".MangaDistrict"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.mangadistrict"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.mangadistrict"
        minSdk = 21
        targetSdk = 34
