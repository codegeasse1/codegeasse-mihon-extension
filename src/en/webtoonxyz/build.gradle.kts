...
// --- Extension metadata -----------------------------------------------
val extName = "WebtoonXYZ"
val extClass = ".WebtoonXYZ"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.webtoonxyz"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.webtoonxyz"
        minSdk = 21
        targetSdk = 34
