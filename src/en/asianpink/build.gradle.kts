...
// --- Extension metadata -----------------------------------------------
val extName = "AsianPink"
val extClass = ".Asianpink"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.asianpink"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.asianpink"
        minSdk = 21
        targetSdk = 34
