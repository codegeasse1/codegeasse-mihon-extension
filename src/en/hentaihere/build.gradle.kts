...
// --- Extension metadata -----------------------------------------------
val extName = "HentaiHere"
val extClass = ".HentaiHere"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.hentaihere"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.hentaihere"
        minSdk = 21
        targetSdk = 34
