...
// --- Extension metadata -----------------------------------------------
val extName = "ManhuaTop"
val extClass = ".ManhuaTop"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.manhuatop"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.manhuatop"
        minSdk = 21
        targetSdk = 34
