...
// --- Extension metadata -----------------------------------------------
val extName = "Diva Scans"
val extClass = ".DivaScans"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.divascans"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.divascans"
        minSdk = 21
        targetSdk = 34
