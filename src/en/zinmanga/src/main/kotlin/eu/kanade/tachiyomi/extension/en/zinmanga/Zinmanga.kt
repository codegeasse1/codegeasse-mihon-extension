...
/*
 * Zinmanga (https://www.zinmanga.net) — WordPress + 2xstorage image CDN.
 *
 *     Popular : /?m_orderby=views       (WP manga cards)
 *     Latest  : /?m_orderby=latest
 *     Search  : /?s=<query>&post_type=wp-manga
 *     Detail  : /manga/<slug>
 *     Chapters: /manga/<slug>/chapter-N   (mix of relative & absolute hrefs)
 *     Pages   : reader .reading-content embeds <img src="https://img-r1.2xstorage.com/<slug>/<chapterId>/<n>.webp">
 */
class Zinmanga : HttpSource() {

    override val name = "Zinmanga"
    override val baseUrl = "https://www.zinmanga.net"
    ...
    private fun parseList(response: Response): MangasPage {
        ...
        val mangas = items.mapNotNull { element ->
            ...
            SManga.create().apply {
                ...
                title = element.text().ifBlank { img?.attr("alt") }?.ifBlank { url.substringAfterLast('/') }.orEmpty()
