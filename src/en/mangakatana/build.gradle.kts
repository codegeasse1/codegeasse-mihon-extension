...
// --- Extension metadata -----------------------------------------------
val extName = "MangaKatana"
val extClass = ".MangaKatana"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.mangakatana"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.mangakatana"
        minSdk = 21
        targetSdk = 34
