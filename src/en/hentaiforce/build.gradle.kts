...
// --- Extension metadata -----------------------------------------------
val extName = "HentaiForce"
val extClass = ".HentaiForce"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.hentaiforce"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.hentaiforce"
        minSdk = 21
        targetSdk = 34
