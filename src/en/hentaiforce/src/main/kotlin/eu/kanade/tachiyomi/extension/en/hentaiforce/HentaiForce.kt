...
/*
 * HentaiForce (https://hentaiforce.net) — doujinshi gallery site.
 *
 *     Latest   : /            (a.gallery-thumb cards; pagination /page/<n> via next link)
 *     Search   : /search?q=<query>
 *     Detail   : /view/<id>/  (h1 title, cover, page thumbs m1.hentaiforce.me/img/<id>-<n>t.jpg)
 *     Pages    : https://m1.hentaiforce.me/img/<id>-<n>.jpg   (strip the trailing 't')
 */
class HentaiForce : HttpSource() {
