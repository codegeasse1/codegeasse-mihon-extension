...
// --- Extension metadata -----------------------------------------------
val extName = "AllPornComics"
val extClass = ".AllPornComics"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.allporncomics"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.allporncomics"
        minSdk = 21
        targetSdk = 34
