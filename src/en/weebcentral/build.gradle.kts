...
// --- Extension metadata -----------------------------------------------
val extName = "WeebCentral"
val extClass = ".WeebCentral"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.weebcentral"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.weebcentral"
        minSdk = 21
        targetSdk = 34
