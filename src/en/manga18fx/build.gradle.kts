...
// --- Extension metadata -----------------------------------------------
val extName = "Manga18fx"
val extClass = ".Manga18fx"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.manga18fx"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.manga18fx"
        minSdk = 21
        targetSdk = 34
