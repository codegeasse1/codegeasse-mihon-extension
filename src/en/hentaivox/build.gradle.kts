...
// --- Extension metadata -----------------------------------------------
val extName = "HentaiVox"
val extClass = ".HentaiVox"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.hentaivox"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.hentaivox"
        minSdk = 21
        targetSdk = 34
