...
// --- Extension metadata -----------------------------------------------
val extName = "Flame Comics"
val extClass = ".FlameComics"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.flamecomics"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.flamecomics"
        minSdk = 21
        targetSdk = 34
