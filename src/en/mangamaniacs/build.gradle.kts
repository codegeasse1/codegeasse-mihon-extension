...
// --- Extension metadata -----------------------------------------------
val extName = "MangaManiacs"
val extClass = ".MangaManiacs"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.mangamaniacs"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.mangamaniacs"
        minSdk = 21
        targetSdk = 34
