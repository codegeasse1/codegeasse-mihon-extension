...
// --- Extension metadata -----------------------------------------------
val extName = "Mangakawaii"
val extClass = ".Mangakawaii"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.mangakawaii"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.mangakawaii"
        minSdk = 21
        targetSdk = 34
