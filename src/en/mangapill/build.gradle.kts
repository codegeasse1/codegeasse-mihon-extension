...
// --- Extension metadata -----------------------------------------------
val extName = "Mangapill"
val extClass = ".Mangapill"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.mangapill"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.mangapill"
        minSdk = 21
        targetSdk = 34
