...
// --- Extension metadata -----------------------------------------------
val extName = "Asura Scans"
val extClass = ".AsuraScans"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.en.asurascans"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.en.asurascans"
        minSdk = 21
        targetSdk = 34
