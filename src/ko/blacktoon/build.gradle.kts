...
// --- Extension metadata -----------------------------------------------
val extName = "BlackToon"
val extClass = ".BlackToon"
...
android {
    namespace = "eu.kanade.tachiyomi.extension.ko.blacktoon"
    compileSdk = 34

    defaultConfig {
        applicationId = "eu.kanade.tachiyomi.extension.ko.blacktoon"
        minSdk = 21
        targetSdk = 34
